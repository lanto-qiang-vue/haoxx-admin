<template>
  <common-table v-model="tableData" :loading="load" :columns="columns" @changePageSize="changePageSize" @changePage="changePage" :total="total"  :show="showTable" :clearSelect="clearType" @onRowClick="onRowClick" @onRowDblclick="dbclick" :page="page">
    <div slot="search"  >
...
<script>
  ...
  export default{
    ...
    methods:{
      ...
      saveOk(){
        this.save({TENANT_ID:this.obj.TENANT_ID,REMARK:this.obj.REMARK ? this.obj.REMARK : "",CHECK_STATUS:"10351002"});
      },
      saveNo(){
