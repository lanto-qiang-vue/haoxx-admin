...
export const getLodop=function(oOBJECT,oEMBED){
    ...
    var strCLodopInstall="<br><p color='#0277bd'>CLodop云打印服务(localhost本地)未安装启动!点击这里<a href='http://www.lodop.net/download.html' style='color:#FF00FF;' target='_blank'>执行安装</a>,安装后请刷新页面。</p>";
