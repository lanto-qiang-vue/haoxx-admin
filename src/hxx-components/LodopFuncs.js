...
export const getLodop=function(oOBJECT,oEMBED){
    ...
    var strCLodopInstall="<br><p color='#0277bd'>CLodop云打印服务(localhost本地)未安装启动!点击这里<b style='color:red;'>本站采用https安全协议。请下载安装云打印C-Lodop扩展版。请注意是扩展版本。火狐浏览器请拷贝https://localhost:8443/到浏览器链接栏添加安全列外。如有疑问请联系客服</b></b><a href='http://www.lodop.net/download.html' style='color:#FF00FF;' target='_blank'>执行安装</a>,安装后请刷新页面。</p>";
