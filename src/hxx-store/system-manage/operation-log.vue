  ...
  <common-table v-model="tableData" :columns="columns" @changePageSize="changePageSize" @changePage="changePage"
    ...
    <div slot="search">
      ...
      <div class="search-block" style="width:250px;">
        <DatePicker v-model="search.start" format="yyyy-MM-dd" type="date" placeholder="开始时间"
                    style="width: 120px;"></DatePicker>
        <DatePicker v-model="search.end" format="yyyy-MM-dd" type="date" placeholder="结束时间"
                    style="width: 120px;margin-left: 5px;"></DatePicker>
      </div>
      <ButtonGroup>
