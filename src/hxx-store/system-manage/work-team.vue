<template>
    ...
    <div slot="left" class="split-pane">
      <Button type="primary" @click="workshop()" style="margin-left:5px;">添加车间</Button>
      <Button type="primary" @click="addwork()" :disabled="canadd" style="margin-left:5px;">添加班组</Button>
      <Button type="info" :disabled="cando" @click="edit()" style="margin-left:5px;">修改</Button>
    ...
    <div slot="right" style="height:100%;">
       <common-table v-model="tableData" :columns="columns" @changePageSize="changePageSize" :showSearch="false" @changePage="changePage" :total="total" :showOperate="type == 2"  :show="showTable" :page="page">
    <div slot="operate">
