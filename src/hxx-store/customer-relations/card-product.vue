<template>
  <common-table v-model="tableData" :columns="columns" @changePageSize="changePageSize" @changePage="changePage" :total="total"  :show="showTable" @changeSelect="changeSelect" :clearSelect="cleartype" @onRowClick="onRowClick" :page="page" @onRowDblclick="dbclick">
    <div slot="search"  >
